...
public class AtendimentoMain {
	public static void main(String[] args) {
		...
		try {
			...
			atendimentoPaciente1.definirPrioridade(somatorioRespostasPaciente1);

			int somatorioRespostasPaciente2 = questionario.fazerPerguntas();
			atendimentoPaciente2.definirPrioridade(somatorioRespostasPaciente2);
			...
			listaAtendimentos.ordenarPorPrioridade();
